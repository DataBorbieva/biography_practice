...
public class Biography {
    public static void main(String[] args) {
      ...
      //  int noBookInfo = 0;
        ...
        System.out.println(Questions.authorIsAlive);         //here I need if condition if author is alive -> ask age
        boolean alive = scan.next().toLowerCase().startsWith("y");                          // if not go to the next question
        ...
        Author author = new Author(name, lastName, country, alive, age, books);
